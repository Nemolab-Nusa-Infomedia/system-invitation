    ...
    return (
        <div className="wedv1">
            ...
            <div className="cover-wedv1 items-center justify-center flex">
                ...
                <div className="flex flex-col items-center text-center p-3 animate-fadeInUp">
                    <img
                    ...
                    >
                        <div className="flex flex-col gap-2 mb-4">
                            <p className="cover-content-wedv1">THE WEDDING OF</p>
                            <h3 className="cover-content-2-wedv1">
                                Rama <b>&</b> Shinta
                            </h3>
                            <h5>19 . 09 . 2024</h5>
                            <p>
                    ...
                    <a
                        ...
                        className="flex btn items-center gap-2 p-2 rounded-md w-fit cover-content-btn-wedv1"
                    >
                        <img
