...
export default function FormPenutup({ onClose }) {
    ...
    return (
        <Form onSubmit={handleSubmit}>
            <div className="px-4 pb-16 py-7  h-[27rem] overflow-auto scrollbar-vertical border-y border-gray-300 ">
                <div className="mempelai-section text-gray-700 flex flex-col ">
                    ...
                    <div className="mempelai-pria flex flex-col mt-1">
                        <TextInput
                            ...
                            className="text-gray-700 w-full p-2 rounded-md border border-gray-300"
                            required
                        />
                        <TextInput
                            type="text"
                            ...
                            className="text-gray-700 w-full p-2 rounded-md border border-gray-300 mt-2"
                            required
                        />
                    </div>
                ...
                <div className="Template text-gray-700 flex flex-col  mt-5">
                    <span className="flex justify-start   font-[600] text-gray-700">
                        Pilih Text Template
                    </span>

                    <div className="pembuka  flex flex-col mt-4">
                        <span className="text-left  font-[500]">Penutup:</span>
